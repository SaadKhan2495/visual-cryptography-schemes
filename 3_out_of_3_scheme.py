...
if not os.path.exists('output/3_out_of_3'):
    os.makedirs('output/3_out_of_3')

if not os.path.exists('output/3_out_of_3/share_1'):
    os.makedirs('output/3_out_of_3/share_1')
else:
    shutil.rmtree('output/3_out_of_3/share_1', ignore_errors=True)
    os.makedirs('output/3_out_of_3/share_1')

if not os.path.exists('output/3_out_of_3/share_2'):
    os.makedirs('output/3_out_of_3/share_2')
else:
    shutil.rmtree('output/3_out_of_3/share_2', ignore_errors=True)
    os.makedirs('output/3_out_of_3/share_2')

if not os.path.exists('output/3_out_of_3/share_3'):
    os.makedirs('output/3_out_of_3/share_3')
else:
    shutil.rmtree('output/3_out_of_3/share_3', ignore_errors=True)
    os.makedirs('output/3_out_of_3/share_3')

if not os.path.exists('output/3_out_of_3/combined'):
    os.makedirs('output/3_out_of_3/combined')
else:
    shutil.rmtree('output/3_out_of_3/combined', ignore_errors=True)
    os.makedirs('output/3_out_of_3/combined')
